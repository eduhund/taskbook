const { calculateMaxScore, calculateScore } = require("../modules/calculators");
...
describe('Calculate Score', () => {
  test.each([
          {name: 'Radio', stateFile: 'data/stateRadio.json', taskFile: 'data/taskRadio.json', score: 20},
          {name: 'Select', stateFile: 'data/stateSelect.json', taskFile: 'data/taskSelect.json', score: 10},
          {name: 'Checkbox', stateFile: 'data/stateCheckbox.json', taskFile: 'data/taskCheckbox.json', score: 30},
          {name: 'Text', stateFile: 'data/stateText.json', taskFile: 'data/taskText.json', score: 100},
          {name: 'Text: too short', stateFile: 'data/stateTextWrong.json', taskFile: 'data/taskText.json', score: 0},
